<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="editpost.aspx.cs" Inherits="Homepage.editpost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:TextBox ID="TextBox2" runat="server" Height="35px" Width="355px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style7">
                <asp:Button ID="Button1" runat="server" Text="Edit" Height="35px" Width="121px" BackColor="#4EAE3A" BorderStyle="Double" OnClick="Button1_Click1" />
            </td>
            <td class="auto-style7">
