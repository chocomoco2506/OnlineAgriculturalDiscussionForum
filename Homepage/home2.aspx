<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home2.aspx.cs" Inherits="Homepage.home2" %>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                     <a class="nav-link " href="index.aspx">view Post</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link " href="createtopic.aspx">CreateTopic</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link " href="mytopic.aspx">MyTopic</a>
                  </li>
